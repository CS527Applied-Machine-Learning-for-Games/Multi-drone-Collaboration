...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--quads_obstacle_mode', default='no_obstacles', type=str, choices=['no_obstacles', 'static', 'dynamic', 'pattern', 'digit_goals', 'two_groups'], help='Choose which obstacle mode to run')
    ...
    p.add_argument('--quads_obstacle_force_mode', default='electron', type=str, choices=['electron', 'gravity'], help='Choose which kind of force mode to use')
